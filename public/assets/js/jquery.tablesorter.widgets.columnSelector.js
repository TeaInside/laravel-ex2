			...
			if (colSel.$container.length) {
				...
				if (wo.columnSelector_mediaquery) {
					...
					colSel.$auto
						...
						//colSel.$auto.find('label input[data-column="auto"]').parent().addClass('hide');//-icee
						//$(this).parent().addClass('hide');
						//colSel.$auto.find('label input[data-column="auto"]').not(':first').parent().remove();
		...
		updateAuto: function(c, wo, $el) {
			...
			if (c.selector.$popup) {
				...
				c.selector.$popup.find('.tablesorter-column-selector')
					...
					//colSel.$auto.find('input [data-column="auto"]').not(':first').parent().remove();
