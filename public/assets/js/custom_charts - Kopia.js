	...
	$.ajax({
		...
		success:function(rows){	
			...
			if(buttonClick===false){
				...
				if(timeSpan=='30mm'){
					$('input[value="30 min"]').removeClass('amChartsButton').addClass('amChartsButtonSelected');
				}else if(timeSpan=='hh'){
					$('input[value="1 h"]').removeClass('amChartsButton').addClass('amChartsButtonSelected');
				}else if(timeSpan=='3hh'){
					$('input[value="3 h"]').removeClass('amChartsButton').addClass('amChartsButtonSelected');
				}else if(timeSpan=='6hh'){
					$('input[value="6 h"]').removeClass('amChartsButton').addClass('amChartsButtonSelected');
				}else if(timeSpan=='12hh'){
					$('input[value="12 h"]').removeClass('amChartsButton').addClass('amChartsButtonSelected');
				}else if(timeSpan=='1DD'){
					$('input[value="1 d"]').removeClass('amChartsButton').addClass('amChartsButtonSelected');
				}else if(timeSpan=='3DD'){
					$('input[value="3 d"]').removeClass('amChartsButton').addClass('amChartsButtonSelected');
				}else if(timeSpan=='7DD'){
					$('input[value="1 w"]').removeClass('amChartsButton').addClass('amChartsButtonSelected');
				}else{
...
function createStockChart(){
	...
	periodSelector.periods=[
		...
		{period:"mm",count:30,label:"30 min"},
		{period:"hh",count:1,label:"1 h"},
		{period:"hh",count:3,label:"3 h"},
		{period:"hh",count:6,label:"6 h",selected:true},
		{period:"hh",count:12,label:"12 h"},
		{period:"DD",count:1,label:"1 d"},
		{period:"DD",count:3,label:"3 d"},
		{period:"DD",count:7,label:"1 w"},
