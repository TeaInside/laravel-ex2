...
<form class="form-horizontal" role="form" method="POST" action="{{{ Confide::checkAction('Admin_SettingController@doEditCoinNews') ?: URL::to('/admin/edit-coin-news') }}}" id="add_post">	
