...
<form class="form-horizontal" role="form" method="POST" action="{{{ URL::to('/admin/edit-withdraw-limit') }}}" id="add_post">	
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <select class="form-control" name="wallet_id" id="wallet_id">
                ...
                <option value="{{{$key}}}" @if ($key == $limit->wallet_id) selected="selected" @endif>{{{$val}}}</option>
                @endforeach
            </select>
        </div>
    </div> 
	<div class="form-group">
	    ...
	    <div class="col-sm-10">
	      <input type="text" class="form-control" name="amount" id="amount" value="{{$limit->amount}}">	      
	    </div>
	</div>	
	<div class="form-group">
	    <div class="col-sm-offset-2 col-sm-10">
	      <input type="hidden" class="form-control" name="limit_id" id="limit_id" value="{{$limit->id}}">
