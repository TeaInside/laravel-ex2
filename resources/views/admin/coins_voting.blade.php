...
<div id="messages"></div>
<div class="add_new"><a href="#">Add new Coin</a></div>
<table class="table table-striped">
    <tbody>
        ...
        <tr>
        	...
        	<td><a href="" onclick="deleteCoin({{$coinvote->id}})">Delete</a></td>
        </tr>
        @endforeach
    </tbody>
</table>
...
function deleteCoin(coinvote_id){
	...
	$.ajax({
		type: 'post',
		url: '<?php echo action('Admin_SettingController@deleteCoinVote')?>',
		datatype: 'json',
