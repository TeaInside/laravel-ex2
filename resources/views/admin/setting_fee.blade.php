...
<form class="form-horizontal" role="form" id="add_fee_market" method="POST" action="{{{ Confide::checkAction('Admin_SettingController@addFeeMarket') ?: URL::to('/admin/add-fee') }}}">
