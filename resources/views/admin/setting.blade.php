...
<form class="form-horizontal" role="form" method="POST" action="/admin/update-setting" enctype="multipart/form-data" id="setting_general">
	...
	<div class="form-group">
		...
		{{ $default_market }}
			<select id="pair" class="form-control" name="default_market">		        
		        <option value="0" >{{ trans('admin_texts.market_default_none') }}</option>
