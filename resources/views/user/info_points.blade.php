		...
		<div id="ecoinstrader-points">
		  <div class="panel panel-default">
			...
			<div class="generaltext">
				<!-- <br>          
				<strong>CoinPal has committed 5% of our trade revenue to go towards our CoinPal Points reward program</strong>         
				<br><br> -->         

				<h4>What Are CoinPal Points?</h4>
				CoinPal Points are rewards points for doing what you are already doing.  At the end of each day we review your activity from trades and referred users and award you points for that activity.
				<br><br>          

				<h4>What Can I Do With CoinPal Points?</h4>
				CoinPal Points can be traded on the exchange under the "Points/BTC" trading pair.  You can transfer CoinPal Points to other users.  You can also use your CoinPal Points to enter weekly drawings for some pretty awesome prizes.   
