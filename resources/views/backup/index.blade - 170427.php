					...
					<div class="row">
						...
						<div class="bs-component">
							...
							<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
								<div class="panel panel-default">
									<div class="panel-body">
										<div ><span aria-hidden="true" class="glyphicon glyphicon-stats"></span></span> 24H Volume:<br><strong><span id="spanVolume-{{{Session::get('market_id')}}}">@if(empty($get_prices->volume)) {{{sprintf('%.8f',0)}}} @else {{sprintf('%.8f',$get_prices->volume)}} @endif</span> {{{ $coinsecond }}}</strong></div>
									</div>
								</div>
							</div>
						...
						<div class="row">
							...
							<!--  <div class="col-xs-12 col-sm-6 col-md-8"> -->
								...
								<h2 ><img width="32" border=0 height="32" src="{{asset('')}}/{{$coinmain_logo}}" /> {{$market_from}}/{{$market_to}} 
							</div>
						</div>
